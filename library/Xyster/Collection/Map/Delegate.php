 ...
 * @license   http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
class Xyster_Collection_Map_Delegate implements Xyster_Collection_Map_Interface
{
    /**
     ...
     *
     * @param Xyster_Collection_Map_Interface $delegate
     */
    public function __construct( Xyster_Collection_Map_Interface $delegate )
    {
     ...
     */
    protected function _setDelegate( Xyster_Collection_Map_Interface $map )
    {
        $this->_delegate = $map;
    }
}