...
class Xyster_Data_Expression extends Xyster_Data_Criterion
{
	...
	public function __toString()
	{
		...
		return $this->_left->getName() . " " . $this->_operator . " " . $string;
	}
	/**
	...
	/**
	 * Equal To Xyster_Data_Expression ( column = 'value' )
	 *
	 * For $value to reference another column, pass a {@link Column} object
	 *
	 * @param string $column
	 * @param string $value
	 * @return Xyster_Data_Expression
	 */
	static public function eq( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * Not Equal To Xyster_Data_Expression ( column <> 'value' )
	 *
	 * For $value to reference another column, pass a {@link Column} object
	 ...
	 * @return Xyster_Data_Expression
	 */
	static public function neq( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * Less Than Xyster_Data_Expression ( column < 3 )
	 *
	 * For $value to reference another column, pass a {@link Column} object
	 *
	 * @param string $column
	 ...
	 * @return Xyster_Data_Expression
	 */
	static public function lt( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * Less Than or Equal To Xyster_Data_Expression ( column <= 3 )
	 *
	 * @param string $column
	 * @param string $value
	 * @return Xyster_Data_Expression
	 */
	static public function lte( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * Greater Than Xyster_Data_Expression ( column > 2 )
	 *
	 * For $value to reference another column, pass a {@link Column} object
	 *
	 * @param string $column
	 ...
	 * @return Xyster_Data_Expression
	 */
	static public function gt( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * Greater Than or Equal To Xyster_Data_Expression ( column >= 2 )
	 *
	 * For $value to reference another column, pass a {@link Column} object
	 *
	 * @param string $column
	 ...
	 * @return Xyster_Data_Expression
	 */
	static public function gte( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * LIKE Xyster_Data_Expression ( column LIKE '%value' )
	 *
	 * @param string $column
	 * @param string $value
	 * @return Xyster_Data_Expression
	...
	/**
	 * NOT LIKE Xyster_Data_Expression ( column NOT LIKE '%value' )
	 *
	 * @param string $column
	 * @param string $value
	 * @return Xyster_Data_Expression
	 */
	static public function notLike( $column, $value )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $value );
	}
	/**
	 * BETWEEN Xyster_Data_Expression ( column BETWEEN 'value' AND 'value' )
	 *
	 * @param string $column
	 * @param string $start
	 * @param string $end
	 * @return Xyster_Data_Expression
	 */
	static public function between( $column, $start, $end )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], array( $start, $end ) );
	}
	/**
	 * Equal To Xyster_Data_Expression ( column NOT BETWEEN 'value' AND 'value' )
	 *
	 * @param string $column
	 * @param string $start
	 * @param string $end
	 * @return Xyster_Data_Expression
	 */
	static public function notBetween( $column, $start, $end )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], array( $start, $end ) );
	}
	/**
	 * In expression ( column IN ( 1,1,2,3,5,8,13,21,'fibonacci','sequence' ) )
	 *
	 * @param string $column
	 * @param array $choices
	 * @return Xyster_Data_Expression
	 */
	static public function in( $column, array $choices )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $choices );
	}
	/**
	 * Not in expression ( column NOT IN ( 1,1,2,3,5,8,13,21,'fibonacci','sequence' ) )
	 *
	 * @param string $column
	 * @param array $choices
	 * @return Xyster_Data_Expression
	 */
	static public function notIn( $column, array $choices )
	{
		return new Xyster_Data_Expression( $column, self::$_operators[__FUNCTION__], $choices );
	}
}