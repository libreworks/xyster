...
/**
 * This is based on the Zend_Db_TestSetup class available in the Zend Framework tests folder
 * 
 * @category   Xyster
 * @package    Xyster_Db
 * @subpackage UnitTests
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Xyster_Db_TestSetup extends PHPUnit_Framework_TestCase
{
    /**
