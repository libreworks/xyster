...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Controller_Action_Helper_FileTest::main');
}
...
require_once 'Xyster/Controller/Action/Helper/File.php';
 ...
 */
class Xyster_Controller_Action_Helper_FileTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Xyster_Controller_Action_Helper_File
     */
    public $helper;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Controller_Action_Helper_FileTest');
    ...
    {
        Zend_Controller_Action_HelperBroker::addPrefix('Xyster_Controller_Action_Helper');
...
// Call Xyster_Controller_Action_Helper_FileTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Controller_Action_Helper_FileTest::main') {
    Xyster_Controller_Action_Helper_FileTest::main();
}
