...
class Xyster_Data_BinderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testBadConstruct()
    {
        ...
        $this->setExpectedException('Xyster_Data_Binder_Exception', 'The type provided must inherit from Xyster_Type_Property_Interface');
        $test = new Xyster_Data_Binder($this->target, new Xyster_Type('string'));
    }
    ...
    {
        $setter = new Xyster_Data_BinderTest_Setter('here');
...
class Xyster_Data_BinderTest_Setter implements Xyster_Type_Property_Interface
{
    public $called = 0;
    public $field;
