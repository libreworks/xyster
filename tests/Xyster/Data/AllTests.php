...
require_once 'Xyster/Data/Field/Mapper/DirectTest.php';
require_once 'Xyster/Data/Field/Mapper/MapTest.php';
require_once 'Xyster/Data/Field/Mapper/MethodTest.php';
...
class Xyster_Data_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite('Xyster_Data_Field_Mapper_DirectTest');
        $suite->addTestSuite('Xyster_Data_Field_Mapper_MapTest');
        $suite->addTestSuite('Xyster_Data_Field_Mapper_MethodTest');
