 ...
 * @version   $Id$
 */
// Call Xyster_Db_Schema_MysqliTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Db_Schema_MysqliTest::main');
}
require_once dirname(__FILE__) . DIRECTORY_SEPARATOR . 'TestCommon.php';
require_once 'Xyster/Db/Schema/Mysqli.php';

/**
 * Test class for Xyster_Db_Schema_Mysqli.
 */
class Xyster_Db_Schema_MysqliTest extends Xyster_Db_Schema_TestCommon
{
    /**
     * @var    Xyster_Db_Schema_Mysqli
     */
    protected $object;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Db_Schema_MysqliTest');
    ...
    {
        $gateway = new Xyster_Db_Schema_Mysqli;
...
// Call Xyster_Db_Schema_MysqliTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Db_Schema_MysqliTest::main') {
    Xyster_Db_Schema_MysqliTest::main();
}
