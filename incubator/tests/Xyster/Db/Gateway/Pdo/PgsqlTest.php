 ...
 * @version   $Id$
 */
// Call Xyster_Db_Gateway_Pdo_PgsqlTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Db_Gateway_Pdo_PgsqlTest::main');
}

require_once dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'TestCommon.php';
require_once 'Xyster/Db/Gateway/Pdo/Pgsql.php';

/**
 * Test class for Xyster_Db_Gateway_Pdo_Pgsql.
 * Generated by PHPUnit on 2008-03-25 at 18:00:34.
 */
class Xyster_Db_Gateway_Pdo_PgsqlTest extends Xyster_Db_Gateway_TestCommon
{
    /**
     * @var    Xyster_Db_Gateway_Pdo_Pgsql
     */
    protected $object;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Db_Gateway_Pdo_PgsqlTest');
    ...
    {
        $gateway = new Xyster_Db_Gateway_Pdo_Pgsql;
    ...
    public function testDropPrimary()
    {
        ...
        $this->object->dropPrimary('forum', 'forum_pkey');
...
// Call Xyster_Db_Gateway_Pdo_PgsqlTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Db_Gateway_Pdo_PgsqlTest::main') {
    Xyster_Db_Gateway_Pdo_PgsqlTest::main();
}
