...
require_once 'Xyster/Container/Behavior/DecoratedTest.php';
...
require_once 'Xyster/Container/Behavior/Factory/DecoratingTest.php';
...
require_once 'Xyster/Container/Injection/Factory/CompositeTest.php';
...
class Xyster_Container_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite('Xyster_Container_Behavior_DecoratedTest');
        ...
        $suite->addTestSuite('Xyster_Container_Behavior_Factory_DecoratingTest');
        ...
        $suite->addTestSuite('Xyster_Container_Injection_Factory_CompositeTest');
