...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Container_Injection_MethodTest::main');
}
 ...
 * Generated by PHPUnit on 2007-12-31 at 09:09:07.
 */
class Xyster_Container_Injection_MethodTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var    Xyster_Container_Injection_Method
     */
    protected $object;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Container_Injection_MethodTest');
...
// Call Xyster_Container_Injection_MethodTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Container_Injection_MethodTest::main') {
    Xyster_Container_Injection_MethodTest::main();
}
