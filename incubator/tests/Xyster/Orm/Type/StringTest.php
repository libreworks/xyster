 ...
 */
class Xyster_Orm_Type_StringTest extends Xyster_Orm_Type_ScalarTestSupport
{
    /**
    ...
    {
        self::assertEquals(Xyster_Db_DataType::Varchar(), $this->object->getDataType());
    }
    ...
    {
        self::assertSame("string", $this->object->getName());
    }
