 ...
 * @version   $Id$
 */
// Call Xyster_Orm_Engine_EntityEntryTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Orm_Engine_EntityEntryTest::main');
}
require_once dirname(dirname(dirname(dirname(__FILE__)))) . DIRECTORY_SEPARATOR . 'TestHelper.php';
require_once 'Xyster/Orm/Engine/EntityEntry.php';
require_once 'Xyster/Orm/Persister/Entity/Interface.php';

/**
 * Test class for Xyster_Orm_Engine_EntityEntry.
 * Generated by PHPUnit on 2008-10-06 at 17:42:16.
 */
class Xyster_Orm_Engine_EntityEntryTest extends PHPUnit_Framework_TestCase
{
    protected $status;
    protected $persister;
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Orm_Engine_EntityEntryTest');
    ...
    {
        $loaded = array(1);
        $entry = new Xyster_Orm_Engine_EntityEntry($this->status, $loaded, 1, 2,
...
// Call Xyster_Orm_Engine_EntityEntryTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Orm_Engine_EntityEntryTest::main') {
    Xyster_Orm_Engine_EntityEntryTest::main();
}
