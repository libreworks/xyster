 ...
 * @version   $Id$
 */
// Call Xyster_Orm_Runtime_Property_VersionTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Xyster_Orm_Runtime_Property_VersionTest::main');
}
require_once dirname(dirname(dirname(dirname(dirname(__FILE__))))) . DIRECTORY_SEPARATOR . 'TestHelper.php';
require_once 'Xyster/Orm/Runtime/Property/Version.php';

/**
 * Test class for Xyster_Orm_Runtime_Property_Version.
 * Generated by PHPUnit on 2008-08-02 at 11:28:52.
 */
class Xyster_Orm_Runtime_Property_VersionTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Xyster_Orm_Runtime_Property_VersionTest');
...
// Call Xyster_Orm_Runtime_Property_VersionTest::main() if this source file is executed directly.
if (PHPUnit_MAIN_METHOD == 'Xyster_Orm_Runtime_Property_VersionTest::main') {
    Xyster_Orm_Runtime_Property_VersionTest::main();
}
