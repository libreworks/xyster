...
/**
 * An abstraction layer for schema manipulation in MySQL (MySQLi version) 
 *
 * @category  Xyster
 * @package   Xyster_Db
 * @copyright Copyright (c) 2007-2008 Irrational Logic (http://irrationallogic.net)
 * @license   http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
class Xyster_Db_Schema_Mysqli extends Xyster_Db_Schema_AbstractMysql
{
    /**
     * Creates a new MySQLi schema adapter
     *
