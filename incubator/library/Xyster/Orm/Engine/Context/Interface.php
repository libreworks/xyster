 ...
 * @license   http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
interface Xyster_Orm_Engine_Context_Interface
{
    /**
     ...
     */
    function addEntityEntry($entity, Xyster_Orm_Engine_Status $status, array $state, Xyster_Orm_Engine_EntityKey $key, $version, $inDatabase, Xyster_Orm_Persister_Entity_Interface $persister, $disableVersion, $lazyUnfetched);
     ...
     */
    function addNullProperty(Xyster_Orm_Engine_EntityKey $key, $propertyName);
     ...
     * @param object $proxy
     */
    function addProxy(Xyster_Orm_Engine_EntityKey $key, $proxy);
     ...
     * @param Xyster_Orm_Collection_Interface $collection
     */
    function addUnownedCollection(Xyster_Orm_Engine_CollectionKey $key, Xyster_Orm_Collection_Interface $collection);
     ...
     * @param object $object
     */
    function checkUnique(Xyster_Orm_Engine_EntityKey $key, $object);
     ...
     * @return boolean
     */
    function containsEntity(Xyster_Orm_Engine_EntityKey $key);
     ...
     * @return array
     */
    function getCachedSnapshot(Xyster_Orm_Engine_EntityKey $key);
     ...
     */
    function getCollection(Xyster_Orm_Engine_CollectionKey $key);
     ...
     * @return object
     */
    function getEntity(Xyster_Orm_Engine_EntityKey $key);
     ...
     * @return object
     */
    function getEntityUnique(Xyster_Orm_Engine_EntityUniqueKey $key);
     ...
     * @return object
     */
    function getProxy(Xyster_Orm_Engine_EntityKey $key);
     ...
     * @return boolean
     */
    function isPropertyNull(Xyster_Orm_Engine_EntityKey $key, $propertyName);
